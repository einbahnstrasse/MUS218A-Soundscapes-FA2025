...
1. **downloaded and installed IRIN** from our Resources page; 
...
1. **Identify** and **manipulate** audio at the microsample level using IRIN.  
2. **Construct** short montage-based passages from a library of small sound units.  
3. **Experiment** with density, discontinuity, and repetition as structural parameters.  
4. **Integrate** IRIN output into Reaper for further editing or spatialization (optional).  
5. **Evaluate** how different micro-gestures combine to form larger perceptual units.  
...
- Filename: `Lastname_Firstname_Micromontage.wav`. Include this in your project folder. 
- Make a `.zip` archive of your folder with everything in it.  
- Submit your IRIN project folder that contains your `.wav` file via Lyceum or cloud link (WeTransfer, Google Drive, etc.).  
